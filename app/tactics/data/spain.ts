...
const primaryFrame = (shape: string, positions: Record<string, Position>): TeamFrame => ({
  teamId: SPAIN_ID,
  shape,
  nodes: Object.fromEntries(Object.entries(positions).map(([slotId, position]) => [slotId, { slotId, roleId: slotId, position }])),
});
...
const frames = [
  ...
  },
  {
    ...
    teams:{
      [SPAIN_ID]:primaryFrame("3-2-5 动态站位",{gk:{x:15,y:50},lb:{x:37,y:20},lcb:{x:34,y:43},rcb:{x:34,y:68},rb:{x:53,y:76},dm:{x:51,y:46},lcm:{x:67,y:30},am:{x:69,y:69},lw:{x:72,y:10},st:{x:76,y:50},rw:{x:73,y:90}}),
  ...
  },
  {
    ...
    teams:{
      [SPAIN_ID]:primaryFrame("3-2-5 五通道",{gk:{x:18,y:50},lb:{x:40,y:19},lcb:{x:40,y:43},rcb:{x:40,y:68},rb:{x:62,y:78},dm:{x:55,y:49},lcm:{x:76,y:30},am:{x:77,y:69},lw:{x:80,y:9},st:{x:83,y:50},rw:{x:80,y:91}}),
  ...
  },
  {
    ...
    teams:{
      [SPAIN_ID]:primaryFrame("五秒反抢圈",{gk:{x:29,y:50},lb:{x:48,y:18},lcb:{x:46,y:40},rcb:{x:48,y:64},rb:{x:57,y:82},dm:{x:58,y:50},lcm:{x:66,y:35},am:{x:69,y:62},lw:{x:72,y:14},st:{x:75,y:49},rw:{x:74,y:87}}),
  ...
  },
  {
    ...
    teams:{
      [SPAIN_ID]:primaryFrame("4-4-2 中低位块",{gk:{x:8,y:50},lb:{x:21,y:18},lcb:{x:20,y:40},rcb:{x:20,y:61},rb:{x:21,y:82},dm:{x:34,y:42},lcm:{x:34,y:64},am:{x:45,y:58},lw:{x:34,y:18},st:{x:46,y:42},rw:{x:34,y:83}}),
